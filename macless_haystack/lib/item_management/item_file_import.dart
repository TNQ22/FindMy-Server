...
class _ItemFileImportState extends State<ItemFileImport> {
  ...
  Future<void> _importAccessory(
    ...
    await FindMyController.savePrivateKeyToStorage(keyPair.hashedPublicKey, accessoryDTO.privateKey);

    String accId = accessoryDTO.id.toString().trim();
    if (accId.isEmpty || accId == 'null') {
      accId = keyPair.hashedPublicKey;
    }
